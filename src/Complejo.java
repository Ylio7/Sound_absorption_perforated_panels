public class Complejo {
    ...
    //dividir un número complejo por un número de tipo double
    //(a, b) / n = (a / n, b / n)
    public Complejo dividir(double n){
        Complejo aux = new Complejo();
        aux.real = real / n;
        aux.imag = imag / n;
        return aux;
    ...
    //Seno y coseno
    public Complejo coseno(){
        Complejo aux = new Complejo();
        aux.real = Math.cos(real)*Math.cosh(imag);
        aux.imag = -Math.sin(real)*Math.sinh(imag);
        return aux;
    }
    
    public Complejo seno(){
        Complejo aux = new Complejo();
        aux.real = Math.sin(real)*Math.cosh(imag);
        aux.imag = Math.cos(real)*Math.sinh(imag);
        return aux;
    }
